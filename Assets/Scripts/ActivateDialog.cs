...
public class ActivateDialog {
    ...
    public void CreateWindow()
    {
        ...
        if (master)
        {
            new TextButton(new Vector2(500, 330), new Vector2(120, 20), "Masters Activated", delegate { activated(); });
        }
        else
        {
            new TextButton(new Vector2(500, 330), new Vector2(120, 20), "Minions Activated", delegate { activated(); });
        }
    }
