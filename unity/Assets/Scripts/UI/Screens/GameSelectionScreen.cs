...
namespace Assets.Scripts.UI.Screens
{
    ...
    public class GameSelectionScreen
    {
        ...
        public void Draw()
        {
            ...
            {
                fcD2E = new FFGImport(FFGAppImport.GameType.D2E, Platform.MacOS, ContentData.ImportPath(), Application.isEditor);
                fcMoM = new FFGImport(FFGAppImport.GameType.MoM, Platform.MacOS, ContentData.ImportPath(), Application.isEditor);
            }
            else
            {
                fcD2E = new FFGImport(FFGAppImport.GameType.D2E, Platform.Windows, ContentData.ImportPath(), Application.isEditor);
                fcMoM = new FFGImport(FFGAppImport.GameType.MoM, Platform.Windows, ContentData.ImportPath(), Application.isEditor);
            }
